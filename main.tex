...
\textbf{Assumption 4 (Judges' Save Preference):} \label{ass:judges_save}
...
\textbf{Assumption 5 (Google Trends as Attention Proxy):} \label{ass:google_trends}
...
\textbf{Assumption 6 (Perturbation Continuity):}
...
\textbf{Assumption 7 (Independence of Perturbations):}
...
\textbf{Assumption 8 (Hierarchical Objective Prioritization):}
